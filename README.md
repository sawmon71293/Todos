...
**Todos** is a website for todo list using firebase and Tailwind CSS
...
<a name="tech-stack">Tailwind CSS,</a>
<a name="tech-stack">React</a>
<a name="tech-stack">Firebase</a>
...
```sh
  cd your-folder
  git clone git@github.com:sawmon71293/Todos.git
```
